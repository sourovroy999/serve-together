...
const CountSystem = () => {
    ...
    return (
         ...
         <section ref={ref} className={`py-16 my-20 ${theme === 'light' && 'bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 '} text-center ${theme !== 'light' && 'bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900'}    `}>
      <h2 className={`text-3xl text-white   font-bold mb-10 ${theme === 'light' && ''}`}>Our Impact</h2>
