...
<div className="max-w-xs mx-auto">
        ...
        <input   defaultValue={thumbnail} name="thumbnail" type="text" placeholder="Thumbnail URL"  className="border text-black max-w-xs py-1 px-2 rounded-md"/>

                <label  className="">Post Title</label> 
        <input   defaultValue={title} name="title" type="text" placeholder="Post Title"  className="border text-black max-w-xs py-1 px-2 rounded-md"/>

                <label className="">Description</label> 
          <textarea defaultValue={description}  
              className='block w-full px-4 py-2 mt-2 
               border border-gray-200 rounded-md text-black focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring'
              name='description'
              id='description'
              cols='30'
            ></textarea>
        ...
        <input  defaultValue={location} name="location" type="text" placeholder="Location"  className="border text-black max-w-xs py-1 px-2 rounded-md"/>

        <label className="">No Of Volunteer Needed</label> 
        <input  defaultValue={volunteernumber} name="volunteernumber" type="number" placeholder="No Of Volunteer Needed"  className="border text-black max-w-xs py-1 px-2 rounded-md"/>
